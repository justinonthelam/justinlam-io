    ...
    return(
      <div className="container">
        <div style={styles.centerJumbo}>
          <div>
            <h1 style={styles.h1}>
              A creator and problem solver with a love for learning.
            </h1>
            <ButtonBar />
        </div>
  ...
  render(){
    ...
    return(
      <div style={styles.buttonRow}>
        <ButtonLink 
          link="https://www.linkedin.com/in/justin-lam/"
          fontAwesome="linkedin-square"
          text="LinkedIn"/>
        <ButtonLink 
          link="https://github.com/justinonthelam"
          fontAwesome="github"
          text="Github"/>
      </div>    
    )
...
class ButtonLink extends Component{
  render(){
    ...
    return(
      <a href={this.props.link} target="_blank" rel="noopener noreferrer" style={styles.container}>
